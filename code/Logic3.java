...
import psp5a_code.output;
import psp5a_code.SimpsonIntegration;
...
public class Logic3 {
	...
	public void logic1a(){
		...
		System.out.println("¿Qué valor tiene x?");
		x = scan.nextDouble();
		System.out.println("¿Cuántos serán los grados de libertad?");
		dof = scan.nextDouble();
